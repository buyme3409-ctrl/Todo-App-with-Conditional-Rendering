...
export default function EditTodo() {
    ...
    //Therefore, we use the useParams hook to get the id from the route.
        ...
        <Container>
            ...
            <Form onSubmit={updateTodo}>
                <Form.Group className="mb-3" controlId="formTitle">
                    ...
                    <Form.Control type="text" placeholder="Get software developer job" value={title} onChange={(e) => setTitle(e.target.value)} required />
                </Form.Group>
                <Form.Group className="mb-3" controlId="formDescription">
                    <Form.Label>Description</Form.Label>
                    <Form.Control as="textarea" rows={3} placeholder={`1. Create amazing project\n2. Apply to Google & Netflix\n3. Crush interview`} value={description} onChange={(e) => setDescription(e.target.value)} required />
                </Form.Group>
